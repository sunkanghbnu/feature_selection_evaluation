# classification/classification_studentsuccess.py
import numpy as np
import pandas as pd
...
def load_studentsuccess_data(file_path='studentsuccess.csv'):
    ...
    le = LabelEncoder()
    y_ture = le.fit_transform(df['Target'])#transform target variable to numerical values
...
if __name__ == "__main__":
    ...
    file_path="/mnt/f/pytorch/feature selection/datasets/studentsuccess/data.csv"
    result_path = "/mnt/f/pytorch/feature selection/datasets/studentsuccess/result_studentsuccess"
    metric_path = "/mnt/f/pytorch/feature selection/datasets/studentsuccess/metric_studentsuccess"
    X, y_true, X_org  = load_studentsuccess_data(file_path)
