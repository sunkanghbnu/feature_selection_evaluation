# classification/classification_heartdisease.py
import numpy as np
import pandas as pd
...
def load_Cleveland_data(file_path='processed.cleveland.data'):
    ...
    # transform target variable to binary (0 or 1)
    ...
    #df_y.to_csv('/mnt/f/pytorch/feature selection/datasets/Heart Disease/y_true.csv',header= None,index=False) 
...
if __name__ == "__main__":
    ...
    file_path="/mnt/f/pytorch/feature selection/datasets/Heart Disease/processed.cleveland.data"
    ...
    X, y_true, X_org = load_Cleveland_data(file_path)
    ...
    models = {
        "svm_classification": SVC(C = 1, kernel = 'linear', gamma = 0.01, random_state = 42),    
