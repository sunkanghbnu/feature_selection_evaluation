...
def load_obesity_data(file_path='bankruptcy.csv'):
...
if __name__ == "__main__":
    ...
    file_path="/mnt/f/pytorch/feature selection/datasets/obesity/ObesityDataSet_raw_and_data_sinthetic.csv"
    ...
    X, y_true, X_org  = load_obesity_data(file_path)
    ...
    num_sets = [ 2,  4,  5,  7,  8, 10, 12, 13, 14, 16]
