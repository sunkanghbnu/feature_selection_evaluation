# classification/classification_spambase.py
import numpy as np
import pandas as pd
...
def load_spambase_data(file_path='spambase.data'):
    ...
    y_true = df.iloc[:, -1].values   # last column as target variable
...
if __name__ == "__main__":
    ...
    file_path = "/mnt/f/pytorch/feature selection/datasets/spambase/spambase.data"
    ...
    X, y_true, X_org = load_spambase_data(file_path)
